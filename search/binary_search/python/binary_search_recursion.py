...
def binary_search_recursion(list: list, start: int, end: int, value: int) -> int:
    ...
    if current_value > value:
        return binary_search_recursion(list=list, start=start, end=mid - 1, value=value)
    ...
    if current_value < value:
        return binary_search_recursion(list=list, start=mid + 1, end=end, value=value)
...
if __name__ == "__main__":  
    ...
    print(binary_search_recursion(data, 0, len(data) - 1, 8))
